...
void Acmen::Allocator::Free(void* p)
{
...
#if defined(_DEBUG)
void Acmen::Allocator::FillFreePage(PageHeader *pPage)
{
    // page header
    pPage->pNext = nullptr;
...
void Acmen::Allocator::FillFreeBlock(BlockHeader *pBlock)
{
    // block header + data
...
void Acmen::Allocator::FillAllocatedBlock(BlockHeader *pBlock)
{
    // block header + data
...
#endif
Acmen::BlockHeader* Acmen::Allocator::NextBlock(BlockHeader *pBlock)
{

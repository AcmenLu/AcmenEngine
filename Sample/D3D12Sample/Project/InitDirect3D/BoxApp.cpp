...
void BoxApp::Update(const GameTimer& gt)
{
	...
	ObjectConstants objConstances;
	XMStoreFloat4x4(&objConstances.WorldViewProj, XMMatrixTranspose(worldviewProj));
	mObjecyCB->CopyData(0, objConstances);
}
...
void BoxApp::Draw(const GameTimer& gt)
{
   ...
   // We can only reset when the associated command lists have finished execution on the GPU.
	...
	ThrowIfFailed(mCommandList->Reset(mDirectCmdListAlloc.Get(), mPos.Get()));
